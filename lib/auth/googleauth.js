...
var GoogleAuth = (function () {
    ...
    GoogleAuth.prototype._checkIsGCE = function (callback) {
        ...
        if (this._isGCE !== undefined) {
            ...
            this.transporter.request('http://metadata.google.internal').then(function(res) {
                if (res.headers) {
    ...
    GoogleAuth.prototype._getGCEProjectId = function (_callback) {
        ...
        this.transporter.request('http://169.254.169.254/computeMetadata/v1/project/project-id', {
            headers: { 'Metadata-Flavor': 'Google' }
        }).then(function(res) {
            if (res.status !== 200 || !res.json) {
                _this.callback(_callback);
            } else {
                _this.callback(_callback, null, res.json);
            }
        }, function() {
          _this.callback(_callback);
        });
